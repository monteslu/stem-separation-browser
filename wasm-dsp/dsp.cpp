    ...
    int& nbFrames)
{
    ...
    // Create padded signal with center padding
    ...
    float* output)
{
    ...
    for (int t = 0; t < nbFrames; t++) {
        ...
        // Undo normalization and prepare full spectrum
        for (int f = 0; f < STFT_BINS; f++) {
    ...
    // Normalize by window sum and extract unpadded signal
